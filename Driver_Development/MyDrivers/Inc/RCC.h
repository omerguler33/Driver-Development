...
/*
 *  RCC  Peripherals Clock Control DISABLE Macro definitions
 *
 */
...
#define RCC_SPI2_CLK_DISABLE()                        ( CLEAR_BIT(RCC->APB1ENR , RCC_APB2ENR_SPI2EN )   )
#define RCC_SPI3_CLK_DISABLE()                        ( CLEAR_BIT(RCC->APB1ENR , RCC_APB2ENR_SPI3EN )   )
